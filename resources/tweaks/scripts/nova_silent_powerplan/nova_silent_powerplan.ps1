...
$TweakName = "Nova Tweaks Silent Power Plan"
$PlanName  = "Nova Tweaks Silent"
...
function Get-PlanDescription {
  ...
  return "$cpuName - Quiet operating profile with reduced boost activity, lower temperatures and less fan noise."
}
