...
try {
  switch ($State) {
    ...
    'On' {
      ...
      foreach ($name in $servicesSeen | Select-Object -Unique) {
      ...
      Out-Result "Enabled" "Font cache rebuilt. Removed entries: $totalRemoved; skipped: $totalSkipped; restart recommended"
    }
