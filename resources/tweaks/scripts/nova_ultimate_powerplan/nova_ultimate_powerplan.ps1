...
$TweakName = "Nova Tweaks Ultimate Power Plan"
$PlanName  = "Nova Tweaks Ultimate"
...
function Get-PlanDescription {
  ...
  return "$cpuName - Maximum performance profile with minimal power-saving behavior for enthusiast workloads."
}
