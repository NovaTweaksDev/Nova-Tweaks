...
$TweakName = "Nova Tweaks Balanced Power Plan"
$PlanName  = "Nova Tweaks Balanced"
...
function Get-PlanDescription {
  ...
  return "$cpuName - Balanced profile with responsive everyday behavior, moderate efficiency and controlled thermals."
}
